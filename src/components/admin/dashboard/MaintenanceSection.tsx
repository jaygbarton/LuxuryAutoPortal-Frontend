...
const TABLE_COLUMNS = [
  ...
  { key: "dropOffDate", label: "Drop Off Date", align: "center" as const },
  { key: "pickUpDate", label: "Pick Up Date", align: "center" as const },
  { key: "assignedTo2", label: "Assigned to", align: "center" as const },
