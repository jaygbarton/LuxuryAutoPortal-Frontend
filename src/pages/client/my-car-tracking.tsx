...
import {
  ...
  Search, X, Fuel, Activity, Layers, Map as MapIcon, Menu, Shield, Route as RouteIcon, ShieldAlert,
} from "lucide-react";
    ...
    <AdminLayout>
      <div className="relative flex overflow-hidden h-full -ml-3 -mr-3 -mt-3 -mb-3 sm:-ml-4 sm:-mr-4 sm:-mt-4 sm:-mb-4 md:-ml-6 md:-mr-6 md:-mt-6 md:-mb-6">
        ...
        <div className={`flex flex-col w-72 lg:w-80 flex-shrink-0 bg-[#1e1e1e] text-white overflow-hidden border-r border-[#2a2a2a]
          ...
          {/* Trip history / behavior / geofence links */}
          <div className="px-3 py-3 border-t border-[#2a2a2a] space-y-2">
            <Link href="/client/vehicle-trips">
            ...
            <Link href="/client/vehicle-behavior">
              <button className="w-full flex items-center gap-2 bg-[#282828] hover:bg-[#313131] border border-[#3a3a3a] rounded-lg px-3 py-2.5 text-left transition-colors">
                <ShieldAlert className="w-4 h-4 text-orange-400 flex-shrink-0" />
                <div>
                  <p className="text-xs font-medium text-gray-100">Driving Behavior</p>
                  <p className="text-[10px] text-gray-400">Braking, acceleration &amp; speeding</p>
                </div>
              </button>
            </Link>
