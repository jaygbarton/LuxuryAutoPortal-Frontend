...
export default function ClientVehicleTripsPage() {
      ...
      <div className="space-y-6">
        <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
          <div>
            ...
            <p className="text-muted-foreground text-sm mt-0.5">GPS-recorded trips for your vehicle(s)</p>
          </div>
            ...
            <CardContent className="p-0">
              {isLoading ? (
                ...
                <div className="flex flex-col items-center justify-center py-12 text-muted-foreground">
                  ...
                  <p className="text-xs mt-1">Trips are recorded automatically via your vehicle's GPS tracker</p>
                </div>
              ) : (
