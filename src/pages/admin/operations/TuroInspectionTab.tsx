...
export function TuroInspectionTab() {
  ...
  return (
    <div className="space-y-6">
      <SectionHeader title="Turo Messages Inspection" subtitle="Completed trips auto-appear here for post-return inspection" variant="plain" />
                    ...
                    <TableRow key={insp.id} className="border-border hover:bg-card/50 transition-colors">
                      ...
                      <TableCell>
                        <div className="flex items-center justify-center gap-1">
                          ...
                          <Button
                            variant="ghost" size="sm"
                            onClick={() => statusUpdateMutation.mutate({ id: insp.id, status: "completed" })}
